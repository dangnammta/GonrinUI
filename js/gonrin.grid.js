		...
		init: function(options) {
            ...
            return this.each(function() {
             ...
             // initialize grid ---------------------------------------------
                ...
                var grid_init = grid.display_grid_lc.call(elem, false);


            });
        },
        render_data: function(page_data,refresh_pag){
        	var elem = this,
            ...
            //page_data = s["data_source"];
            page_data_len = page_data.length;
            
            row_primary_key = s.primary;
         ...
         // create data table
            ...
            for(i in s.fields) {
                if(column_is_visible(s.fields[i])) {
                    sorting_indicator = "";
            ...
            if(s.row_primary_key && s.selected_ids.length > 0) {
                ...
                if(s.row_selection_mode == "single" || s.row_selection_mode == "multiple") {
                    ...
                    $("#" + table_id + " tbody tr").each(function() {
                        ...
                        idx = methods.selected_rows.call(elem, "selected_index", row_id);
                        if(idx > -1) {
                            methods.selected_rows.call(elem, "mark_selected", row_id);
                        }
                    });
                }
            }
        ...
        display_grid: function(refresh_pag) {
            ...
            var res = $.ajax({
                ...
                success: function(data) {
                    ...
                    // update selected rows counter
                    methods.selected_rows.call(elem, "update_counter");
